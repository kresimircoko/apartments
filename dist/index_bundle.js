...
/***/ function(module, exports, __webpack_require__) {
	...
	var USER_DATA = {
	  name: 'Krešimir Čoko',
	  username: 'kresimircoko',
	  image: 'https://scontent-vie1-1.xx.fbcdn.net/v/t1.0-9/12809548_10206548353562326_1338152829764000762_n.jpg?oh=941f6543c6af18405a3a7eb9ed43099d&oe=57E5C3D9'
	};
	...
	var Link = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'span',
	      { onClick: this.changeURL, style: { color: 'blue', cursor: 'pointer' } },
	      this.props.children
	    );
	  }
	});
